...
@section('page-content')
    <div class="main-container container-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">Album</h1>
                </div>
                ...
                @if ($albumList->isNotEmpty())
                    @foreach ($albumList as $item)
                        <tr>
                            ...
                            <td class="align-middle">{{ $item->album }}</td>
                            <td class="align-middle">
                                <a href="{{ route('admin.album.edit', $item->id) }}" class="btn btn-primary"><i
                                        class="fa fa-edit"></i> Edit</a>
                                <form method="POST" id="delete-data-form"
                                    action="{{ route('admin.album.destroy', $item->id) }}" hidden>
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                </form>
