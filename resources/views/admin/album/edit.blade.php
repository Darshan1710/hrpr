    ...
    <div class="main-container container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('admin.album.update', $album->id) }}">
                    <div class="card text-white bg-dark mb-3">
                        <div class="card-header">
                            <h2 class="m-0">Edit Album</h2>
                        </div>
                        <div class="card-body">
                            {{ csrf_field() }}
                            {{ method_field('patch') }}
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" name="album" class="form-control" id="album"
                                    value="{{ old('category', $album->album) }}" required autofocus>
                            </div>
                            <!-- /category -->
                        </div>
