...
@section('page-content')
    <div class="main-container container-fluid">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="text-primary mr-auto">Client</h1>
                </div>
                ...
                @if ($clientList->isNotEmpty())
                    @foreach ($clientList as $item)
                        <tr>
                            ...
                            <td class="align-middle">{{ $item->client_title }}</td>
                            <td class="align-middle">                           
                                 <img src="{{ asset('assets/images/client_images/' . $item->image_path) }}" alt="" width="120px" height="120px">
                            </td>
                            <td class="align-middle">
                                <a href="{{ route('admin.client.edit', $item->id) }}" class="btn btn-primary"><i
                                        class="fa fa-edit"></i> Edit</a>
                                <form method="POST" id="delete-data-form"
                                    action="{{ route('admin.client.destroy', $item->id) }}" hidden>
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                </form>
